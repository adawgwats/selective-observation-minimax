...
def test_b_n_manual() -> None:
    ...
    raise NotImplementedError("Uncomment once compute_b_n is implemented")
...
def test_r_n_ipw_identity_large_sample() -> None:
    ...
    # Response probability depends on y: q(y) = sigmoid(-y) bounded [0.1, 0.9]
    q_true_func = lambda y: np.clip(1.0 / (1.0 + np.exp(y)), 0.1, 0.9)
    ...
    raise NotImplementedError("Implement after compute_r_n; tolerance 5% for n=20000")
